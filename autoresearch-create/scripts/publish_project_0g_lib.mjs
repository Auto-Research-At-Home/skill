...
export function buildCreateProjectInputs(options) {
  ...
  return {
    ...
    protocolIrysId: options.protocolIrysId,
    ...
    baselineMetricsIrysId: options.baselineMetricsIrysId,
    tokenName,
    tokenSymbol,
